...
#include "ch11_BankAccount.h"  //the class definition
#include "ch11_CheckingAccount.h"  //the class definition
using namespace std;
	...
	do {
		...
		switch (choice)
		{
			...
			case 4 : cout << "Account number. " ;
					 ...
					 break;
			case 5 : cout << "Transaction Fee. ";
			         studentAccount.setTransactionFee(getValidData());
			         break;
...
void displayMenu()
{
	...
	cout << "5. Set the transaction fee\n";
